...
//   return (
//     <div
//       className={`group md:w-56 lg:w-72 sm:w-full  border-gray-200  transition-all hover:shadow-lg mt-6  bg-[#fff9f3] `}
//     >
...
//       <div className="p-4">
//         <h3 className="line-clamp-2 text-md font-medium text-gray-900 hover:underline font-serif">
...
//               ${
//                 inStock
//                   ? "bg-[#d7d4cd] text-black hover:bg-[#a29686]"
//                   : "cursor-not-allowed bg-gray-300 text-gray-500"
//               }`}
//           >
