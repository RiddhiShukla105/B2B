...
const Admin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios.post(`${import.meta.env.VITE_API_URL}/api/product/create-product`,formData,{headers:{"Content-Type":"multipart/form-data"}})
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      ...
      <div className="max-w-4xl mx-auto bg-orange-50 shadow-xl rounded-2xl p-10 mt-10">
